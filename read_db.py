...
dump_to_hdf5_name = "/home/cri/mf_datasets/tmqm_xtb_dataset/tmqm_dataset_xtb.hdf5"
with sqlitedict.SqliteDict(
    ...
    with h5py.File(dump_to_hdf5_name, "w") as f:
        for key in tqdm(keys):
            ...
            record.attrs["u"] = str(xtb_properties.geometry.u)
            ...
            record.attrs["u"] = str(xtb_properties.energy.u)
            ...
            record.attrs["u"] = str(xtb_properties.forces.u)
            ...
            record.attrs["u"] = str(xtb_properties.partial_charges.u)
            ...
            record.attrs["u"] = str(xtb_properties.dipole_moment.u)
            ...
            record.attrs["u"] = str(xtb_properties.total_charge.u)
